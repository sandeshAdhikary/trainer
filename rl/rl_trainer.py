...
class RLTrainer(Trainer, ABC):
    ...
    def __init__(self, config: Dict, model: Model = None, logger: Logger = None) -> None:
        ...
        self.save_buffer_after_train = config.get('save_buffer_after_train', False)
    ...
    def after_train(self, info=None, save_buffer_after_train=False):
        """
        ...
        self._save_checkpoint(ckpt_state_args={
            'save_buffer': save_buffer_after_train,
