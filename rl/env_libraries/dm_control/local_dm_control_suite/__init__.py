...
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import acrobot
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import ball_in_cup
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import cartpole
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import cheetah
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import finger
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import fish
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import hopper
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import humanoid
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import humanoid_CMU
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import lqr
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import manipulator
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import pendulum
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import point_mass
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import quadruped
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import reacher
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import stacker
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import swimmer
from trainer.rl.env_libraries.dm_control.local_dm_control_suite import walker
