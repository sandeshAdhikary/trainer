...
if __name__ == '__main__':
    study_config_path = '/project/src/studies/configs/bisim_study_defaults.yaml'
    run_config_path = '/project/src/studies/configs/bisim_override.yaml'
    ...
    test = OmegaConf.merge(study_cfg, run_cfg)
    test = OmegaConf.to_container(test, resolve=True)
