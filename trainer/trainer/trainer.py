...
class Trainer(ABC):
    ...
    def set_queue(self, queue: TrainingQueue) -> None:
        self.queue = queue
    ...
    def _setup(self, config: Dict = None, model: Model = None, logger: Logger =None, queue: TrainingQueue=None) -> None:
